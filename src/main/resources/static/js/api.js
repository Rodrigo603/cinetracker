const API = (() => {
    ...
    return {
        ...
        listarFilmes, criarFilme, atualizarFilme, deletarFilme, criarAdmin, buscarAdmin, atualizarAdmin,
        buscarFilmePorId, buscarSeriePorId, listarSeries, listarEpisodiosDaSerie,
        criarAvaliacao,atualizarAvaliacao,deletarAvaliacao, listarAvaliacoesFilme, listarAvaliacoesSerie
    };
})();